    ...
    <Layout>
      <div className="flex mx-90 my-20">
        <div className="text-white mt-10">
          <h1 className="text-8xl">Bounty Swap</h1>
          ...
          <button className="font-bold cursor-pointer border-2 bg-gradient-to-r from-blue-400 to-blue-600 my-5 px-8 py-2 rounded-full text-white hover:bg-blue-500">Start Trading</button>
          <div className="mt-15">
